...
#https://docs.python.org/3/library/argparse.html these are the commandline arguments.
...
# function for the tcp client that will communicate with the server
def client(server, port, file):
    # we create an socket that will handle TCP connection and connect to it through the host and prot
